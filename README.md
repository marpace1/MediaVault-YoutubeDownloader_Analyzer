...
MediaVault-All_in_one_youtube_downloader_aka_analyzer
...
> **FFmpeg**, wrapped in a polished glassmorphism UI.

MediaVault is built with **Electron + React + TypeScript**, styled with
**TailwindCSS** and animated with **Framer Motion**. It uses **better-sqlite3**
for download history and a robust background download manager with a real queue,
concurrency control, pause/resume/cancel/retry, live progress, and graceful
error recovery.
